...
export async function GET(request: NextRequest) {
  ...
  let query = supabase
    .from("events")
    .select(
      "id, title, title_ar, title_ur, description, description_ar, description_ur, category, event_date, start_time, end_time, location, speaker, registration_url, image_url"
    )
